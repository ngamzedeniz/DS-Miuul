...
df_ = pd.read_csv(r"C:\Users\Sade\Desktop\VBO\python\Modul_2_CRM_Analitiği\FLO_CLTV_Tahmini-221020-121219\FLO_CLTV_Tahmini\flo_data_20k.csv")
df = df_.copy()
