{
  ...
  "metadata": {
    "colab": {
      "provenance": [],
      "authorship_tag": "ABX9TyMmfVQ7eInxcidWVscUqn4p",
  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/ngamzedeniz/Veri-Bilimi-Okulu/blob/main/Python_Al%C4%B1%C5%9Ft%C4%B1rmalar.ipynb\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "markdown",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "oKAXeY73eiUY",
        "outputId": "ae87225f-80c5-4e6a-b938-da51e82d9e5e"
      },
      "execution_count": 4,
      "outputs": [
        {
          ...
          "text": [
            ...
            "['D', 'A', 'T', 'A', 'S', 'C', 'I', 'C', 'E']\n",
            "Adım 5\n",
            "['D', 'A', 'T', 'A', 'S', 'C', 'I', 'C', 'E', 'NTIST']\n",
            "Adım 6\n",
            "['D', 'A', 'T', 'A', 'S', 'C', 'I', 'C', 'N', 'NTIST']\n"
          ]
        }
      ]
    },
